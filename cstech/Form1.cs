...
namespace cstech
{
    public partial class Form1 : Form
    {
        ...
        public int kullaniciBulunanSayi;   // Sayıyı bulduktan sonra bulunan sayıda değişiklikler yapmak için kullanılan değişkenler
        public int kullaniciBulunanSayiKonum = 0;
        public int kullaniciBulunanArti = 0;
        public int kullaniciIlerlediMi = 0;
        public int kullaniciIlerlediMi2 = 0;

        private void Form1_Load(object sender, EventArgs e)
        {
            bilgisayarTutulanSayi = sayiUret();
            bilgisayarTahminEttigiSayi = 1234;
        }
            ...
            else
            {
                if (artiBilgisi != -1)
                {
                    if (artiBilgisi < bilgisayarGonderilenArti)
                    {
                        ...
                        if (kullaniciIlerlediMi == 1)
                            kullaniciIlerlediMi = 0;
                        else
                        {
                    ...
                    else if (artiBilgisi > bilgisayarGonderilenArti)
                    {
                        ...
                        {
                            kullaniciIlerlediMi = 0;
                            kullaniciIlerlediMi2 = 1;
                        }
                        else
                        {
                            yerDegistirme(konumi, konumj);
                            kullaniciIlerlediMi2 = 0;
                        }
                ...
                else
                {
                    ...
                    kullaniciBulunanArti = bilgisayarGonderilenArti;
                    artiBilgisi = bilgisayarGonderilenArti;
                    yerDegistirme(konumi, konumj);
                }
            }
        ...
        private void sonIhtimalMi()
        {
            if (konumj == 4 && konumi == 3) // En son ihtimalde olmuyorsa bilgisayar kaybediyor
            {
                ...
                char degisme = bulunanSayiIlkHali[0];
                bulunanSayiIlkHali[0] = bulunanSayiIlkHali[kullaniciBulunanSayiKonum + 1];
                bulunanSayiIlkHali[kullaniciBulunanSayiKonum + 1] = degisme;
                artiBilgisi = kullaniciBulunanArti;
                kullaniciIlerlediMi = 1;
                kullaniciIlerlediMi2 = 0;
